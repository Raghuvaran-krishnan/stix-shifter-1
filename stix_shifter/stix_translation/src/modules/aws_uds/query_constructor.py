...
class QueryStringPatternTranslator:
    ...
    def __init__(self, pattern: Pattern, data_model_mapper, log_type):
...
def translate_pattern(pattern: Pattern, data_model_mapping, options):
    ...
    final_queries = QueryStringPatternTranslator(pattern, data_model_mapping, log_type).qualified_queries
